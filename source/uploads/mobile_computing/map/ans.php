...
<span class="span_div span_2 hide" >
	...
	<map name="ans2">
	  <area shape="circle" coords="270,40,22" href="javascript:void(0);" class="next" rel="3">
	  <input type="text" name="url1" class="url1" value="" style="position: absolute; border: medium none; left: 32%; top: 6%; width: 200px;">
	</map> 
</span>
