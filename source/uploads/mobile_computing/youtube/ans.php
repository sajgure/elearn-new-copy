...
<span class="span_div span_2 hide" >
	...
	<map name="ans2">
	  <area shape="circle" coords="275,35,15" href="javascript:void(0);" class="next" rel="3">
	  <input type="text" name="url1" class="url1" value="" style="position: absolute; border: medium none; width: 130px; top: 5%; left: 47%;">
	</map> 
</span>
<span class="span_div span_3 hide" >
	...
	<map name="ans3">
	  <area shape="square" coords="5,60,290,150" href="javascript:void(0);" class="next" rel="4">
	</map>
</span>
