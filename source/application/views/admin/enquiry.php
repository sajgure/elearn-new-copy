					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption font-blue">
								...
								<span class="caption-subject bold uppercase"> Student Enquiry</span>
							</div>
							<div class="actions tools">
								<button class="btn btn-success popup_save" type="button" rev="enquiry_form" data-title="Enquiry Form"> Enquiry <i class=" icon-plus"></i></button>
							</div>	
						</div>
						<div class="portlet-body">
							<table class="table table-striped table-hover table-bordered datatable" data-url="enquiry_table">
								<thead>
									<tr>
										...
										<th style="text-align:center;"> Student E-Mail </th>
										<th style="text-align:center;"> Student Qualification </th>
										<th style="text-align:center;"> Student Address </th>
