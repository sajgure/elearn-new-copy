...
<head>
<meta charset="utf-8"/>
<title>Elearn | eth Tutorial</title>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="col-md-12 ">
				...
				<?php $section=$this->uri->segment(2); $file1=str_replace('%20', ' ', $section); ?>
				<div class="portlet light">
					<div class="portlet-title">
						<div class="caption font-blue">
							<span class="caption-subject bold uppercase"> Tutorials > <?php echo $file1; ?></span>
						</div>
					</div>
			              ...
			              <?php if(isset($files) && !empty($files))
			              {
			                  foreach ($files as $key) 
			                  {
			                      ...
			                      <div class="col-md-2" style="padding: 15px;">
			                          <center>
			                              <a style="text-decoration: none;" href="<?php echo base_url(); ?>eth_video/<?php echo $file1; ?>/<?php echo $file; ?>" title="<?php echo $file; ?>"><img src="<?php echo base_url()?>assets/img/watch_video.png" height="55px" width="55px">
