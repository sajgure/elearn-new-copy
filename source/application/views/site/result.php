        ...
        <div class="page-content">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($course_id==7){ ?>40<?php }else{ ?>50<?php } ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <b><?php if($course_id==7){if($obj_marks<20){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';}}else{if($obj_marks<26){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';}} ?></b> </span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <?php $cnt=$letter_result->DeletedCount -($letter_result->InsertedCount+$letter_result->StyleChangesCount);
                                            $letter_marks = 15-($cnt/2); echo round($letter_marks,2); ?>
                                        </td>
                                        <td>
                                            <span class="label label-sm <?php if($letter_marks < 7.5){ echo 'label-warning'; $flag=1;}else{ echo 'label-success';} ?> ">
                                            <b><?php if($letter_marks < 7.5){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';} ?></b> </span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            if($type=="statement") 
            {
                ...
                if($course_id != '7')
                {
                    ...
                    {
                        $statement_que_base64 =$statement_data->statement_ans_base64;
                    }
                ...
                $total_marks=10;
                if(isset($statement_result->errList) && !empty($statement_result->errList))
                { 
                    if($course_id == '1' || $course_id == '2' || $course_id == '3')
                    {
                        $d_cnt=5; $h1=$h2=$a=$b=$w=1;
                        $datamiss = $heading = $sub_heading = $border = $align = array();
                        foreach ($statement_result->errList as $key) 
                        {
                            if(trim($key->errorMessage)=='Number Of Rows does not Match' && trim($key->actualData)<=1)
                            {
                                $d_cnt=$h1=$h2=$a=$b=$w=0;
                            }
                            else
                            {    
                                ...
                                {
                                    if((trim($key->expectedData)=='' && trim($key->actualData)=='') || (trim($key->expectedData)=='null' && trim($key->actualData)=='')) 
                                    {
                                    }
                                    else
                                    {
                        ...
                        if($d_cnt<0){ $d_cnt=0; } $total_marks=$d_cnt+$h1+$h2+$a+$b+$w; if($total_marks>10) { $total_marks=10; } 
                    }
                    if($course_id == '4' || $course_id == '5' || $course_id == '6')
                    {
                        $d_cnt=5; $q=2; $h1=$h1_2=$h2=$a=$b=$w=0.5; 
                        $datamiss = $que = $heading = $heading2 = $sub_heading = $border = $align = array();
                        foreach ($statement_result->errList as $key) 
                        {
                            if(trim($key->errorMessage)=='Number Of Rows does not Match' && trim($key->actualData)<=1)
                            {
                                $d_cnt=$q=$h1=$h1_2=$h2=$a=$b=$w=0;
                            }
                            else
                            {    
                                if($key->category=='DATAMISS')
                                {
                                    ...
                                    {
                                        $expectedData=explode("(",$key->expectedData);
                                        if(trim($expectedData[0])=='AVERAGE' || trim($expectedData[0])=='MIN' || trim($expectedData[0])=='MAX' || trim($expectedData[0])=='SUM')
                                        {
                                            $que[] = array("errorMessage"=>trim($key->errorMessage), "cellDetails"=>trim($key->cellDetails), "expectedData"=>trim($key->expectedData), "actualData"=>trim($key->actualData), "category"=>trim($key->category));
                                            $q=$q-0.5;
                                        }
                                        else
                                        {
                                ...
                                {
                                    if(trim($key->cellDetails)=='workbook1 -> Sheet1 -> B3' && trim($key->errorMessage)!='Cell Font Size does not Match')
                                    {
                                        $heading[] = array("errorMessage"=>trim($key->errorMessage), "cellDetails"=>trim($key->cellDetails), "expectedData"=>trim($key->expectedData), "actualData"=>trim($key->actualData), "category"=>trim($key->category));
                                        $h1=0;
                                    }  
                                    else if(trim($key->cellDetails)=='workbook1 -> Sheet1 -> B4')
                                    {
                                        $heading2[] = array("errorMessage"=>trim($key->errorMessage), "cellDetails"=>trim($key->cellDetails), "expectedData"=>trim($key->expectedData), "actualData"=>trim($key->actualData), "category"=>trim($key->category));
                                        $h1_2=0;
                                    }  
                                    else if(trim($key->cellDetails)=='workbook1 -> Sheet1 -> B5' || trim($key->cellDetails)=='workbook1 -> Sheet1 -> C5' || trim($key->cellDetails)=='workbook1 -> Sheet1 -> D5' || trim($key->cellDetails)=='workbook1 -> Sheet1 -> E5' || trim($key->cellDetails)=='workbook1 -> Sheet1 -> F5' || trim($key->cellDetails)=='workbook1 -> Sheet1 -> G5' || trim($key->cellDetails)=='workbook1 -> Sheet1 -> H5' || trim($key->cellDetails)=='workbook1 -> Sheet1 -> E6' || trim($key->cellDetails)=='workbook1 -> Sheet1 -> F6' || trim($key->cellDetails)=='workbook1 -> Sheet1 -> G6' || trim($key->cellDetails)=='workbook1 -> Sheet1 -> H6')
                                    {
                                        $sub_heading[] = array("errorMessage"=>trim($key->errorMessage), "cellDetails"=>trim($key->cellDetails), "expectedData"=>trim($key->expectedData), "actualData"=>trim($key->actualData), "category"=>trim($key->category));
                                        $h2=0;
                                    }
                                    ...
                                    else if(trim($key->errorMessage)!='Cell Font Size does not Match')
                                    {
                                        $align[] = array("errorMessage"=>trim($key->errorMessage), "cellDetails"=>trim($key->cellDetails), "expectedData"=>trim($key->expectedData), "actualData"=>trim($key->actualData), "category"=>trim($key->category));
                                        $a=0;
                                    }
                        ...
                        if($d_cnt<0){ $d_cnt=0; } $total_marks=$d_cnt+$q+$h1+$h1_2+$h2+$a+$b+$w; if($total_marks>10) { $total_marks=10; } 
                    }
                } 
                ...
                <?php if($statement_result)
                { ?>
                    <div class="row">
                        <div class="col-md-12">
                            <?php if(trim($key->errorMessage)=='Number Of Rows does not Match' && trim($key->actualData)<=1)
                            { ?>
                                <center><p style="font-size: 14px;">You did not attempt statement..</p></center>
                                <br>
                            <?php } else { ?>
                                <div class="panel-group accordion" id="accordion3">
                                            ...
                                            <div class="panel-body">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <?php if(isset($datamiss) && !empty($datamiss)) {
                                                        ...
                                                        <tr>
                                                            <td colspan="4">No Mistakes Found</td>
                                                        </tr>
                                                    <?php } ?>
                                                </table>
                                            </div>
                                        ...
                                        <div id="collapse_3_2" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <?php if((isset($heading) && !empty($heading)) || (isset($heading2) && !empty($heading2)) ) {
                                    ...
                                    { ?>
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                <a style="color: #F3565D; text-decoration: none;" class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_6">
                                                <b>Question Answer</b> </a>
                                                </h4>
                                            </div>
                ...
                <div class="row main_div">
                    ...
                    <div class="col-md-6">
                        <div class="portlet light">
                            ...
                            <div class="portlet-body form">
                                <div class="scroller" style="height:400px;" data-always-visible="1" data-rail-visible="1" data-rail-color="blue" data-handle-color="red">
                                    <p style="text-align:justify; color: black; white-space: pre-wrap; font-size: 14px;" class="ans"><?php echo $passage_data['student_passage']; ?></p>
                                </div>
                            </div>
                        </div>
                        <!-- END SAMPLE FORM PORTLET-->
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <a type="button" href="<?php echo base_url(); ?>shorthand_practice/<?php  echo $time;?>" class="btn btn-sm btn-primary" style="padding: 1px 5px; font-weight: bold; margin: 0px; float: right;"><b><span id="hm_timer"></span></b>Restart</a>
                                    </div>
                                </div>
                            </div>
                            <div class="portlet-body form">
