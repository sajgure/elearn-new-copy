<?php $exam_start = $this->session->userdata('exam_start');
if(isset($exam_start) && !empty($exam_start))
{   
		    ...
		    <div class="portlet" >
			    <div class="portlet-body">
					...
					<span>
						...
						<label style="color: #000;""><b>Select language for objective:-</b></label>
						<div class="portlet-input input-inline input-small">
							<select class="form-control select2me lang_set"  name="section">
