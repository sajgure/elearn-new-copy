...
<head>
    <meta charset="utf-8">
    <title>Elearn | Shorthand Section One</title>
	      	...
	      	<div class="span12">
	      		<div id="target-1" class="widget">
	      			<div class="widget-content" style="border-radius: 20px; height: 270px; padding: 1% 10%">
						<form action="javascript:void(0);" rel="save_main_shorthand_section1" id="test_form" >
							<div class="portlet-body " style="min-height:385px;">
								<br>
								<center>
									<span style="color: #19BC9C; font-size: 35px;"><b>Section A</b></span><br><br>
									<h3>Please hear audio proper</h3>
									<br><br>
									<input type="hidden" name="section1_que" value="<?php echo (isset($section_data->shorthand_id) && !empty($section_data->shorthand_id) )?$section_data->shorthand_id:''; ?>">
