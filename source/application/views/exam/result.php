      	...
      	<div class="row">
					...
					<div class="widget-content">
						<table width="100%" style=" width:100%; border-color: #000;" border="1">
							...
							<tr>
								...
								<td style="text-align:center; color: #000;"><?php if($course_id==7){if($obj_marks<20){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';}}else{if($obj_marks<26){ echo 'FAIL'; $flag=1;}else{ echo 'PASS';}} ?></td>
							</tr>
							<?php if($course_id!=7){ ?>
							<tr>
				...
				<div class="span6">
					<div class="widget" >
						<div class="widget-content">	
							...
							<hr>
							<div class="scroller" style="height:450px;"  data-always-visible="1" data-rail-visible="1" data-rail-color="blue" data-handle-color="red">
								<p style="text-align:justify; color: black;" class="ans"><?php echo  $passage_data['passage']; ?></p>
							</div>	
						</div>
					</div>
				</div>
			...
			<?php if($course_id==7){ ?>	
				<div class="span12">
		      		<div class="widget">
						<div class="widget-content">
							<span class=" bold uppercase" style="font-size: 15px; color: #000;"><b>Section 2 &nbsp;<i class="icon-arrow-right  "></i>  Mobile Computing</b></span>
						</div>	
					</div> 		
				</div>	
				<?php for ($i=0; $i <5; $i++) { ?>
						...
						<div class="portlet-body portlet-section" style="max-height: 920px;" id="portlet-section">
							<div style="min-height:370px;pointer-events:none; -webkit-touch-callout: none; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none;-ms-user-select: none;user-select: none; height: 920px; max-height: 920px; background-image: url('<?php echo base_url(); ?>uploads/letter.png'); background-size: 100% 100%;">
								<div class="letter" style="padding: 37% 8% 5% 10%;">
									<?php if ($letter_que_data->course_id==2 || $letter_que_data->course_id==3 || $letter_que_data->course_id==5 || $letter_que_data->course_id==6) { ?>
