                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption font-blue">
                            <span class="caption-subject bold uppercase">Batch wise question</span>
                        </div>
                    </div>
                                        ...
                                        <div class="dashboard-stat blue">
                                            ...
                                            <div class="details">
                                                <div class="number" style="font-size: 24px !important;">
                                                    <?php echo (isset($year) && !empty($year))?$year:'';?> 
                                                </div>
                                                <div class="desc">
                                                    <?php echo (isset($key->batch) && !empty($key->batch))?'Batch '.$key->batch:'';?>
                                                </div>
                                            </div>
                                            <a class="more" href="<?php echo base_url();?>view_question/<?php echo (isset($year) && !empty($year))?$year:'';?>/<?php echo (isset($key->batch) && !empty($key->batch))?$key->batch:'';?>">
                                            Solve Quesions <i class="m-icon-swapright m-icon-white"></i>
                                            </a>
                                        </div>
                                    </div>
                                <?php $i++; } 
