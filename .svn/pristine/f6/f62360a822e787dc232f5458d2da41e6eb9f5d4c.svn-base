...
class Imageupload
{
	...
	function image_upload($array)
    {
		...
		$max_width=isset($array['max_width'])?$array['max_width']:'5000';
		$max_height=isset($array['max_height'])?$array['max_height']:'5000';
		$overwrite=isset($array['overwrite'])?$array['overwrite']:'TRUE';
		$fieldname = isset($array['fieldname'])?$array['fieldname']:'';//compulsary
		$resize = isset($array['resize'])?$array['resize']:TRUE;
		...
		$resize_width=isset($array['resize_width'])?$array['resize_width']:'400';//compulsary if resized
		$resize_height=isset($array['resize_height'])?$array['resize_height']:'400';//compulsary if resized
		...
		$allowed_types=isset($array['allowed_types'])?$array['allowed_types']:'*';// file format
