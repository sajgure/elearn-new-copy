...
<head>
<meta charset="utf-8"/>
<title>Elearn | Statement Practice</title>
        ...
        <div class="page-content" style="padding-left: 5px;">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon" style="float: right;">
                                    <div class="product-quantity" style="margin-right: 5px;">
                                        <input style="height:21px; font-size: 13px;" type="text" value="<?php echo $this->uri->segment(3); ?>"  max="<?php echo (isset($statement->cnt) && !empty($statement->cnt) )?trim($statement->cnt):''; ?>" class="form-control input-sm jump_to_val" placeholder="Question Number">
                                    </div>      
                    ...
                    <div class="portlet-body form">
                        <div style="height: 650px; width: 100%">
                            <object type="application/x-silverlight-2" height="100%" width="100%;">
                                ...
                                <param name="initParams" value="title=MSCEIA EXAM,iseditable=false,base64result=<?php echo $statement->statement_base64;?>">
                            </object>
                        </div>
                        <div class="row">
            ...
            <div class="col-md-6" style="padding: 2px;">
                ...
                <div class="portlet light" style="padding: 1px;">
                    <div class="portlet-title"  style="padding: 13px;">
                        <div class="row">
                            <?php if($time=='no') { ?> <div class="col-sm-5"> <?php } else { ?> <div class="col-sm-9"> <?php } ?>
                                <i class="fa fa-file-text font-blue"></i>
                                <span class="caption font-blue caption-subject bold uppercase"> Statement Practice <i class="fa fa-angle-right"></i> Answer</span>
                            </div>
                            <?php if($time=='yes') { ?>
                                <div class="col-sm-3">
                    ...
                    <div class="portlet-body form">
                        <form action="javascript:void(0);" rel="save_statement_practice" id="test_form" runat="server" style="margin: 0px !important;" >
                            <input type="hidden" class="form-control" name="statement_id" id="statement_id" value="<?php echo (isset($statement->statement_id) && !empty($statement->statement_id) )?$statement->statement_id:''; ?>" >
                            ...
                            <div id="silverlightControlHost" style="height: 650px; width: 100%">
                                <object id="statement"  data="data:application/x-silverlight-2," type="application/x-silverlight-2" height="100%" width="100%;">
                                    ...
                                    <param name="initParams" value="title=MSCEIA EXAM,iseditable=true,urlPath=<?php echo base_url();?>save_statement_practice1">
                                </object>
                                <iframe id="_sl_historyFrame" style="visibility:hidden;height:0px;width:0px;border:0px"></iframe>
                            </div>
                            <div class="row">
                                <div class="col-md-12"  style="margin:10px;">
                                    <center><button id="statement_practice" class="btn blue btn-success btn_submit_test" rel=""></i>Submit</button> </center>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    if(isset($time) && !empty($time) && ($time)=='yes') { 
        if($course_id==7) { ?> 
            $('#hm_timer').countdowntimer({minutes :23, seconds : 2, timeUp: test_expiry }); 
        <?php } else {?> 
            $('#hm_timer').countdowntimer({minutes :20, seconds : 2, timeUp: test_expiry });
        <?php }
    }
    else { ?>
