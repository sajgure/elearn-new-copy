...
<div class="page-container" style="padding-right: 5px;">
    ...
    <div class="page-content-wrapper">
        ...
        $this->session->unset_userdata("statement_ans_id");
        $this->session->set_userdata("statement_ans_id",$statement_id);
        ?>
            ...
            <div class="col-md-6" style="padding: 2px;">
                ...
                <div class="portlet light" style="padding: 1px;">
                    <div class="portlet-title"  style="padding: 13px;">
                        <div class="row">
                            <?php if($time=='no') { ?> <div class="col-sm-12"> <?php } else { ?> <div class="col-sm-9"> <?php } ?>
                                <i class="fa fa-file-text font-blue"></i>
                                <span class="caption font-blue caption-subject bold uppercase"> Statement Practice <i class="fa fa-angle-right"></i> Answer</span>
                                <span class="caption font-blue caption-subject bold uppercase" style="float: right;"> Remaining Statement <i class="fa fa-angle-right"></i> <?php echo $count_data->statement_count; ?></span>
                            </div>
                            <?php if($time=='yes') { ?>
                                <div class="col-sm-3">
                    ...
                    <div class="portlet-body form">
                        <form action="javascript:void(0);" rel="save_statement_ans" id="test_form" runat="server" style="margin: 0px !important;" >
                            ...
                            <div id="silverlightControlHost" style="height: 650px; width: 100%">
                                <object id="statement"  data="data:application/x-silverlight-2," type="application/x-silverlight-2" height="100%" width="100%;">
                                    ...
                                    <param name="initParams" value="title=MSCEIA EXAM,iseditable=true,urlPath=<?php echo base_url();?>save_statement_ans_data">
                                </object>
