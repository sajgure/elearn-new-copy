					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption font-blue">
								<i class="fa fa-certificate font-blue"></i>
								<span class="caption-subject bold uppercase"> Bonafide </span>
							</div>
							<div class="actions tools">
								<button class="btn btn-success popup_save" type="button" rev="add_bonafied" data-title="Bonafide Form"> Add Bonafide <i class=" icon-plus"></i></button>
							</div>	
						</div>
						<div class="portlet-body">
							<table class="table table-striped table-hover table-bordered datatable" data-url="bonafied_table">
								<thead>
									<tr>
