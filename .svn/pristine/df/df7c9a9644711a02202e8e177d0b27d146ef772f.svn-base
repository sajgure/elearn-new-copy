...
<head>
<meta charset="utf-8"/>
<title>Elearn | Video Tutorial</title>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="col-md-12 ">
              ...
              <i class="fa fa-video-camera font-blue"></i>
							<span class="caption-subject bold uppercase"> Video Tutorials</span>
						</div>
					</div>
               ...
               <?php if(isset($files) && !empty($files))
               {
                   foreach ($files as $key) 
                   {
                       ...
                       <div class="col-md-2" style="padding: 15px;">
                           <center>
                               <a style="text-decoration: none;" href="<?php echo base_url();?>tutorials_video/<?php echo $dir; ?>" title="<?php echo $dir; ?>" ><img src="<?php echo base_url()?>assets/img/folder.png" height="50px" width="50px">
                               <div><b><?php echo substr($dir, 0, 15); ?>....</b></div></a>
                           </center>
                       </div>
                   <?php  }
               }
                   ...
                   <div class="col-md-12" style="padding: 15px;">
                     <center><h3>Please install DVD first.</h3></center>
                   </div>
                <?php }  ?>
            </div>
					</div>
